...
public class tp3_01 {
    public static void main(String[] args) {
        ...
        // Ordenacao Parcial por Selecao (k = 10)
        int k = 10;
        ...
        for (int i = 0; i < k; i++) {
            ...
            for (int j = i + 1; j < numIds; j++) {
                comparacoes++;
                if (selecionados[j].getNome().compareTo(selecionados[menor].getNome()) < 0) {
                    menor = j;
                }
            }
            if (menor != i) {
        ...
        // Gerar log
        try {
            FileWriter fw = new FileWriter("892665_selecao_parcial.txt");
