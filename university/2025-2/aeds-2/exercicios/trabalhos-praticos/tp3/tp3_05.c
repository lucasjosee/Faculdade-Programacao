...
// Desvincula e retorna o primeiro elemento da estrutura, atualizando os nos
...
// Desvincula e retorna o ultimo elemento da estrutura, atualizando os nos
    ...
    if (scanf("%d", &n) == 1) {
        for (int i = 0; i < n; i++) {
            ...
            if (strcmp(comando, "II") == 0) {
                int r_id;
                scanf("%d", &r_id);
                inserirInicio(get_restaurante_by_id(c, r_id));
            } else if (strcmp(comando, "I*") == 0) {
                int pos, r_id;
                scanf("%d %d", &pos, &r_id);
                inserir(get_restaurante_by_id(c, r_id), pos);
            } else if (strcmp(comando, "IF") == 0) {
                int r_id;
                scanf("%d", &r_id);
                inserirFim(get_restaurante_by_id(c, r_id));
